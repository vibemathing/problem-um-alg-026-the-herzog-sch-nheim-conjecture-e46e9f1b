...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-alg-026-the-herzog-sch-nheim-conjecture-e46e9f1b-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/ALG-026"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-alg-026-the-herzog-sch-nheim-conjecture-e46e9f1b-v1",
      "problem_contract_sha256": "89c7762e4d0e34895ead32139af277dfff3b3f763de6f6cbe1602b852d9ad42f",
      "problem_id": "problem:um-alg-026-the-herzog-sch-nheim-conjecture-e46e9f1b",
      "route_id": "route:um-alg-026-the-herzog-sch-nheim-conjecture-e46e9f1b-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-alg-026-the-herzog-sch-nheim-conjecture-e46e9f1b-source-fidelity-01",
      "graph_id": "graph:um-alg-026-the-herzog-sch-nheim-conjecture-e46e9f1b-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-alg-026-the-herzog-sch-nheim-conjecture-e46e9f1b-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-alg-026-the-herzog-sch-nheim-conjecture-e46e9f1b-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "If a finite system of left cosets of subgroups of a group $G$ partitions $G$, must some two subgroups have the same index?"
          },
          "statement_sha256": "eaec2f168f255a41224e7c267bc84b73b8afc0bbff573ea16910c07341fdfd2c"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-alg-026-the-herzog-sch-nheim-conjecture-e46e9f1b-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-alg-026-the-herzog-sch-nheim-conjecture-e46e9f1b-root",
      "route_id": "route:um-alg-026-the-herzog-sch-nheim-conjecture-e46e9f1b-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-alg-026-2b34d348edbf",
        "url": "https://www.unsolvedmath.com/problems/ALG-026"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
